    ...
    <header class="maga-report-header">
      <el-form ref="form" :model="search" size="mini">
        ...
        <el-row>
          ...
          <el-button size="mini" type="primary" @click="areaReportExport" v-if="havePermission('report:areaexport')">导出杂志地区对账EXCEL</el-button>
          <el-button size="mini" type="primary" @click="areaReportExportByAdmin" v-if="havePermission('report:byadminexport')">导出杂志业务员明细EXCEL</el-button>
        </el-row>
      </el-form>
    </header>
